let fs,jwt,AsyncLock,InputError,AccessError;_dd0‍.x([["save",()=>save],["reset",()=>reset],["assertValidUserId",()=>assertValidUserId],["getUserIdFromAuthorization",()=>getUserIdFromAuthorization],["login",()=>login],["logout",()=>logout],["register",()=>register],["assertValidChannel",()=>assertValidChannel],["getChannels",()=>getChannels],["getChannel",()=>getChannel],["addChannel",()=>addChannel],["updateChannel",()=>updateChannel],["joinChannel",()=>joinChannel],["leaveChannel",()=>leaveChannel],["inviteChannel",()=>inviteChannel],["deleteChannel",()=>deleteChannel],["getUsers",()=>getUsers],["getUser",()=>getUser],["updateProfile",()=>updateProfile],["getMessages",()=>getMessages],["sendMessage",()=>sendMessage],["deleteMessage",()=>deleteMessage],["editMessage",()=>editMessage],["pinMessage",()=>pinMessage],["unpinMessage",()=>unpinMessage],["reactMessage",()=>reactMessage],["unreactMessage",()=>unreactMessage]]);_dd0‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_dd0‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_dd0‍.w("async-lock",[["default",["AsyncLock"],function(v){AsyncLock=v}]]);_dd0‍.w("./error",[["InputError",["InputError"],function(v){InputError=v}],["AccessError",["AccessError"],function(v){AccessError=v}]]);
...
// userId is an integer
  ...
  resolve();
       ...
       const deleteChannel = (authUserId, channelId) => channelLock((resolve, reject) => {
  assertChannelMember(authUserId, channelId);
