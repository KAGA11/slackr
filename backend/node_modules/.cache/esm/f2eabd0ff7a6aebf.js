let express,swaggerUi,cors,morgan,InputError,AccessError,BACKEND_PORT,swaggerDocument,save,getUserIdFromAuthorization,login,logout,register,assertValidChannel,assertValidUserId,getChannels,getChannel,addChannel,updateChannel,joinChannel,leaveChannel,inviteChannel,deleteChannel,getUsers,getUser,updateProfile,getMessages,sendMessage,deleteMessage,editMessage,pinMessage,unpinMessage,reactMessage,unreactMessage,getPinnedMessages;_f7a‍.x([["default",()=>_f7a‍.o]]);_f7a‍.w("express",[["default",["express"],function(v){express=v}]]);_f7a‍.w("swagger-ui-express",[["default",["swaggerUi"],function(v){swaggerUi=v}]]);_f7a‍.w("cors",[["default",["cors"],function(v){cors=v}]]);_f7a‍.w("morgan",[["default",["morgan"],function(v){morgan=v}]]);_f7a‍.w("./error",[["InputError",["InputError"],function(v){InputError=v}],["AccessError",["AccessError"],function(v){AccessError=v}]]);_f7a‍.w("../../frontend/src/config",[["BACKEND_PORT",["BACKEND_PORT"],function(v){BACKEND_PORT=v}]]);_f7a‍.w("../swagger.json",[["default",["swaggerDocument"],function(v){swaggerDocument=v}]]);_f7a‍.w("./service",[["save",["save"],function(v){save=v}],["getUserIdFromAuthorization",["getUserIdFromAuthorization"],function(v){getUserIdFromAuthorization=v}],["login",["login"],function(v){login=v}],["logout",["logout"],function(v){logout=v}],["register",["register"],function(v){register=v}],["assertValidChannel",["assertValidChannel"],function(v){assertValidChannel=v}],["assertValidUserId",["assertValidUserId"],function(v){assertValidUserId=v}],["getChannels",["getChannels"],function(v){getChannels=v}],["getChannel",["getChannel"],function(v){getChannel=v}],["addChannel",["addChannel"],function(v){addChannel=v}],["updateChannel",["updateChannel"],function(v){updateChannel=v}],["joinChannel",["joinChannel"],function(v){joinChannel=v}],["leaveChannel",["leaveChannel"],function(v){leaveChannel=v}],["inviteChannel",["inviteChannel"],function(v){inviteChannel=v}],["deleteChannel",["deleteChannel"],function(v){deleteChannel=v}],["getUsers",["getUsers"],function(v){getUsers=v}],["getUser",["getUser"],function(v){getUser=v}],["updateProfile",["updateProfile"],function(v){updateProfile=v}],["getMessages",["getMessages"],function(v){getMessages=v}],["sendMessage",["sendMessage"],function(v){sendMessage=v}],["deleteMessage",["deleteMessage"],function(v){deleteMessage=v}],["editMessage",["editMessage"],function(v){editMessage=v}],["pinMessage",["pinMessage"],function(v){pinMessage=v}],["unpinMessage",["unpinMessage"],function(v){unpinMessage=v}],["reactMessage",["reactMessage"],function(v){reactMessage=v}],["unreactMessage",["unreactMessage"],function(v){unreactMessage=v}],["getPinnedMessages",["getPinnedMessages"],function(v){getPinnedMessages=v}]]);// import fs from 'fs';
